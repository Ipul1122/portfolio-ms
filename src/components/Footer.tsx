...
const SOCIAL_LINKS = [
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/muhammad-syaifulloh-99a233305?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/pul_ipul_pul?igsh=MWJ5eXV3eTVsN2N3dA%3D%3D',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  return (
    <footer className="footer-root">
      ...
      <div className="container-fluid">
        ...
        {/* Bottom row */}
        <div className="footer-bottom text-center items-center ">
          <span className="footer-copy">
            &copy; {year} {t('footerCopy')}
          </span>
        </div>
      </div>
    </footer>
