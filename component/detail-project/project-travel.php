<article id="project-travel" class="hidden max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="md:col-span-2">
            ...
            <a href="https://ipul1122.github.io/pellortranstravel.io/index.html" target="_blank" rel="noopener noreferrer" 
                class="w-full sm:w-auto mb-5 inline-flex justify-center items-center gap-2 px-8 py-3 bg-primary text-white font-bold rounded-xl hover:bg-secondary transition-all shadow-lg hover:shadow-primary/30">
